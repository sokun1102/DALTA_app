...
*   **Là một** khách truy cập (Guest), **tôi muốn** có thể đăng ký tài khoản bằng email và mật khẩu hoặc qua Google, **để** tôi có thể mua hàng, theo dõi đơn hàng và nhận ưu đãi.
